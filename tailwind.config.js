...
const generatePalette = require(path.resolve(
  __dirname,
  'src/@Components/tailwind/utils/generate-palette'
))
...
const config = {
  ...
  plugins: [
    ...
    require(path.resolve(
      __dirname,
      'src/@Components/tailwind/plugins/extract-config'
    )),
    require(path.resolve(__dirname, 'src/@Components/tailwind/plugins/utilities')),
    require(path.resolve(__dirname, 'src/@Components/tailwind/plugins/icon-size')),
    require(path.resolve(__dirname, 'src/@Components/tailwind/plugins/theming'))({
      themes
    }),
